...
# Create contants (soil profile properties, correction factors for Thornthwaite eq., etc)
depletion.order = c(8, 7, 16, 6, 15, 24, 5, 14, 23, 32, 4, 13, 22, 31, 40, 3, 12, 21, 30,
...
depletion.req =   c(1.0, 1.0, 1.0, 1.0, 1.02, 1.03, 1.05, 1.07, 1.09, 1.11, 1.13, 1.15, 1.17, 1.19, 1.21, 1.23, 1.26,
